I have generated the Extension using the Wizard at
...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\salattimes on
     Windows, /home/user/dev/salattimes on Linux) in a file named
     salattimes@mainulhossain and copy that file to
